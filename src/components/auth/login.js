                    ...
                    <div className="loginForm">
                        <div className='fromGroup'>
                            ...
                            <div className={'form-group name' + (submitted && !user.email ? ' form-control is-invalid' : '')}>
                                        <input type="text" placeholder='Enter Email-ID' className='form-control-register-lr' name="email" value={user.email} onChange={this.handleChange} />
                                    </div>
                            <div className={'form-group name' + (submitted && !user.password ? ' form-control is-invalid' : '')}>
                              <input type="password" placeholder='Enter Password' className='form-control-register-lr' name="password" value={user.password} onChange={this.handleChange} />
                            </div>
